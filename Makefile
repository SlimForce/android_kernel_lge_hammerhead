...
CPP		= $(CC) -E
ifeq ($(ENABLE_GRAPHITE),true)
REAL_CC        += -fgraphite -floop-flatten -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block
...
KBUILD_CFLAGS	+= -Os $(call cc-disable-warning,maybe-uninitialized,) $(call cc-disable-warning,array-bounds,) 
else
KBUILD_CFLAGS += $(call cc-disable-warning,maybe-uninitialized,) $(call cc-disable-warning,array-bounds,) 
endif
