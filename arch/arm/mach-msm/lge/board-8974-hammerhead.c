...
static struct memtype_reserve const msm8974_reserve_table[] __initconst = {
	[MEMTYPE_SMI] = {
	},
	[MEMTYPE_EBI0] = {
...
static struct reserve_info const msm8974_reserve_info __initconst = {
...
static struct of_dev_auxdata const msm8974_auxdata_lookup[] __initconst = {
